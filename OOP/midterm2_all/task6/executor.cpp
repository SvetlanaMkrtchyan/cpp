...
double executeWithStack(
    ...
    while ((int)cpu.ip < (int)prog.size()) {
        ...
        case OpCode::JMP_REL:  cpu.ip += (int32_t)inst.resIdx; break;
        case OpCode::JMP_IF_FALSE: if (regs[inst.resIdx] == 0.0) cpu.ip = inst.leftIdx; break;
        case OpCode::JMP_IF_TRUE:  if (regs[inst.resIdx] != 0.0) cpu.ip += (int32_t)inst.leftIdx; break;
        case OpCode::BR_GT:    if (regs[inst.resIdx] >  regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::BR_LT:    if (regs[inst.resIdx] <  regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::BR_EQ:    if (regs[inst.resIdx] == regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::BR_GTE:   if (regs[inst.resIdx] >= regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::BR_LTE:   if (regs[inst.resIdx] <= regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::BR_GT_U:  if ((uint32_t)regs[inst.resIdx] >  (uint32_t)regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::BR_LT_U:  if ((uint32_t)regs[inst.resIdx] <  (uint32_t)regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::BR_GTE_U: if ((uint32_t)regs[inst.resIdx] >= (uint32_t)regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::BR_LTE_U: if ((uint32_t)regs[inst.resIdx] <= (uint32_t)regs[inst.leftIdx]) cpu.ip += (int32_t)inst.rightIdx; break;
        case OpCode::JA:
        case OpCode::JAE:
        case OpCode::JB:
        case OpCode::JBE:
